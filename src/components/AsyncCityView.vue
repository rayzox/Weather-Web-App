    ...
    <div class="flex flex-col flex-1 items-center">
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-white">
                ...
                <div class="flex gap-10 overflow-x-scroll [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
...
const getWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/3.0/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=${owmApiKey}&units=metric`);
